...
def get_idempotency_repository(session: SessionDep) -> IdempotencyRepository:
...
def get_create_ticket_use_case(
    ...
    return CreateTicketUseCase(client, events, tickets, outbox, idempotency)
